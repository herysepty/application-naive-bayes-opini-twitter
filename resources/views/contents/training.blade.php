...
<div class="col-md-12">
    ...
    <div class="card">
        <div class="header" id="netral">
            <h4 class="title">Daftar tweet training netral ({{ count($tweets_netral) }})<a href="{{ URL('training/clear/negatif') }}" class="btn btn-info btn-xs btn-fill pull-right">Clear data training netral</a></h4>
