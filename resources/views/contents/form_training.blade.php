                        ...
                        <div class="col-md-12">
                            <div class="form-group text-center {{ $errors->has('tweet') ? ' has-error' : '' }}">
                                ...
                                <label class="checkbox-inline"> 
                                    <input type="radio" name="tipetraining" value="n" {{ (old('tipetraining')=='n') ? 'checked' : ""}}> Netral 
                                </label> 
                                <label class="checkbox-inline"> 
                                    <input type="radio" name="tipetraining" value="p" {{ (old('tipetraining')=='p') ? 'checked' : ""}}> Positif 
                                </label>
                                <label class="checkbox-inline"> 
